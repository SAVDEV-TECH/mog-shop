...
// }
// function Prodpage({Product }: { Product: productsparam }) {
...
//         {/* Sidebar for categories (mobile version) */}
//         {isMobile ? (
//           <div className={`${isfixed ? "sticky top-10" : ""} w-full md:w-[20%]`}>
...
//               const imageSrc = Array.isArray(e.images) && e.images.length ? e.images[0] : "/globe.svg";
//               return (
